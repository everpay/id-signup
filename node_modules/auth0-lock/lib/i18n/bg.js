...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Достигнахте лимита на опити за смян на паролата. Моля изчакайте преди да опитате отново.',
    ...
    login: {
      ...
      password_leaked: 'Засякохме потенциялен проблем със сигурността на този профил. За да предпазим профила Ви, ние блокирахме потребителското Ви име. Ще получите имейл с инструкции как да деблокирате профила си.',
      ...
      too_many_requests: 'Съжаляваме. В момента има твърде много искания. Моля, презаредете страницата и опитайте отново. Ако това продължи, моля, опитайте отново по-късно.',
      invalid_captcha: 'Решете предизвикателния въпрос, за да се уверите, че не сте робот.',
      invalid_recaptcha: 'Поставете отметка, за да се уверите, че не сте робот.'
    },
    passwordless: {
  ...
  forgotPasswordInstructions: 'Моля напишете имейл адреса си. Ще Ви изпратим имейл, за да промените паролата си.',
  ...
  captchaMathInputPlaceholder: 'Решете формулата, показана по-горе'
};
